...
async def showHighScores(ctx, client, message):
    ...
    # Get data
    readFile = open("cogs/games/dungeon/dungeonScores.txt", "r")
...
def generateMerchantGoods():
    ...
    # Get data
    weapons = getFromFile3("cogs/games/dungeon/weaponList.txt", "|")
    items = getFromFile3("cogs/games/dungeon/itemList.txt", "|")
...
def saveScore(uid, floor):
    ...
    # Write back to file
    writeFile = open("cogs/games/dungeon/dungeonScores.txt", "w")
...
def spawnMonster():
    ...
    numOfMonsters = 4
    monster = getFromFile2("cogs/games/dungeon/monsterList.txt",
